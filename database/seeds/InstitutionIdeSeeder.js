...
const INSTITUTION_FILE = __dirname + '/files/ides/ides.csv';
const CAMPUS_FILE = __dirname + '/files/ides/ides-campus.csv';

class InstitutionIdeSeeder {
    async run() {
...
module.exports = InstitutionIdeSeeder
