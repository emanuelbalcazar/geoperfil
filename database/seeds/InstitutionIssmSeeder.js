...
const INSTITUTION_FILE = __dirname + '/files/issm/issm.csv';
const CAMPUS_FILE = __dirname + '/files/issm/issm-campus.csv';

class InstitutionIssmSeeder {
    async run() {
...
module.exports = InstitutionIssmSeeder
